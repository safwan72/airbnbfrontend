    ...
    <div className="h-[64px] flex flex-row items-center justify-between border rounded-full">
      <div className="hidden lg:block">
        <div className="flex flex-row justify-between items-center">
          <div className="px-8 w-[250px] h-[64px] flex flex-col rounded-full justify-center hover:bg-gray-100 ">
            <p className="text-xs font-semibold">Where?</p>
            <p className="text-sm">Wanted Location</p>
          </div>
          <div className="px-8 h-[64px] flex flex-col rounded-full justify-center hover:bg-gray-100 ">
      ...
      <div className="p-2">
        <div className="p-4 bg-airbnb rounded-full text-white hover:bg-airbnbdark transition hover:cursor-pointer">
          <svg
            viewBox="0 0 32 32"
